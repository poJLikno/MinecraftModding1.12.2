...
public class ItemTobaccoSeeds extends Item implements IPlantable {
	...
	public EnumActionResult onItemUse(EntityPlayer player, 
		...
		if (facing == EnumFacing.UP && 
			...
			worldIn.setBlockState(pos.up(), InitBlocks.TOBACCO.getDefaultState());
			stack.shrink(1);
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		return InitBlocks.TOBACCO.getDefaultState();
	}
}
